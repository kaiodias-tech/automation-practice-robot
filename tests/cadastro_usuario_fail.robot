...
Resource            ../resources/pages/registration_made_fail.robot

Test Setup          Start Session
Test Teardown       Finish Session

***Test Cases***
Criando uma conta no portal - Falha
    ...
    registration_made_fail.Conferir se o cadastro foi efetuado com sucesso